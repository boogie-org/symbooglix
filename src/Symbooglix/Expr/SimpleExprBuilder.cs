...
namespace Symbooglix
{
    public class SimpleExprBuilder : IExprBuilder
    {
        private FunctionCall CreateBVBuiltIn(string Name, string Builtin, Microsoft.Boogie.Type returnType, IList<Microsoft.Boogie.Type> argTypes)
        {
            ...
            var funcCall = InternalCreateUninterpretedFunctionCall(Name, returnType, argTypes);
        ...
        public FunctionCall CreateUninterpretedFunctionCall(string name, Microsoft.Boogie.Type returnType, IList<Microsoft.Boogie.Type> argTypes)
        {
            ...
            {
                functionCall = InternalCreateUninterpretedFunctionCall(name, returnType, argTypes);
        ...
        // No caching
        private FunctionCall InternalCreateUninterpretedFunctionCall(string Name, Microsoft.Boogie.Type returnType, IList<Microsoft.Boogie.Type> argTypes)
        {
