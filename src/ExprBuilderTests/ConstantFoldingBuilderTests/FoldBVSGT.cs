...
{
    [TestFixture()]
    public class FoldBVSGT : ConstantFoldingExprBuilderTests
    {
        // lhs +ve and rhs +ve
        ...
        public void simpleBVSGT(int lhsValue, int rhsValue, int bitWidth, bool expectedTruth)
        {
            var cfb = GetConstantFoldingBuilder();
            var result = cfb.BVSGT(cfb.ConstantBV(lhsValue, bitWidth), cfb.ConstantBV(rhsValue, bitWidth));
