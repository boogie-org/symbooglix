...
{
    [TestFixture()]
    public class FoldLt : ConstantFoldingExprBuilderTests
    {
        [Test()]
        public void simpleConstantIntEqual()
        {
            ...
            var result = cfb.Lt(constant0, constant1);
        ...
        public void foldSameExpr()
        {
            ...
            var foldedResult = cfb.Lt(side, side);
        ...
        public void NoFold()
        {
            ...
            var foldedResult = cfb.Lt(v0.Item2, v1.Item2);
            var simpleResult = sfb.Lt(v0.Item2, v1.Item2);
            CheckIsBoolType(foldedResult);
