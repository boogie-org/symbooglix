// This test case exposed a bug where two Execution states
...
procedure {:source_name "foo"} {:kernel} $foo();
...
implementation {:source_name "foo"} {:kernel} $foo()
{
  var $0$1: bv1;
  var $0$2: bv1;
  var $1$1: bv1;
  ...
  $0:
    ...
    v15$1 := $$acc$15bv32$1;
    v15$2 := $$acc$15bv32$2;
    v16$1 := FADD32(v3$1 ++ v2$1 ++ v1$1 ++ v0$1, FMUL32(1065353216bv32, 1073741824bv32));
    v16$2 := FADD32(v3$2 ++ v2$2 ++ v1$2 ++ v0$2, FMUL32(1065353216bv32, 1073741824bv32));
    v17$1 := FADD32(v7$1 ++ v6$1 ++ v5$1 ++ v4$1, FMUL32(1073741824bv32, 1073741824bv32));
    v17$2 := FADD32(v7$2 ++ v6$2 ++ v5$2 ++ v4$2, FMUL32(1073741824bv32, 1073741824bv32));
    v18$1 := FADD32(v11$1 ++ v10$1 ++ v9$1 ++ v8$1, FMUL32(1077936128bv32, 1073741824bv32));
    v18$2 := FADD32(v11$2 ++ v10$2 ++ v9$2 ++ v8$2, FMUL32(1077936128bv32, 1073741824bv32));
    v19$1 := FADD32(v15$1 ++ v14$1 ++ v13$1 ++ v12$1, FMUL32(1082130432bv32, 1073741824bv32));
    v19$2 := FADD32(v15$2 ++ v14$2 ++ v13$2 ++ v12$2, FMUL32(1082130432bv32, 1073741824bv32));
    ...
    assert {:sourceloc_num 5} {:thread 1} $0$1 != 0bv1;
    assert {:sourceloc_num 5} {:thread 2} $0$2 != 0bv1;
    v35$1 := $$acc$4bv32$1;
    v35$2 := $$acc$4bv32$2;
    v36$1 := $$res2$0bv32$1;
    v36$2 := $$res2$0bv32$2;
    ...
    assert {:sourceloc_num 10} {:thread 1} $1$1 != 0bv1;
    assert {:sourceloc_num 10} {:thread 2} $1$2 != 0bv1;
    v46$1 := $$acc$8bv32$1;
    v46$2 := $$acc$8bv32$2;
    v47$1 := $$res3$0bv32$1;
    v47$2 := $$res3$0bv32$2;
    ...
    assert {:sourceloc_num 15} {:thread 1} $2$1 != 0bv1;
    assert {:sourceloc_num 15} {:thread 2} $2$2 != 0bv1;
    v57$1 := $$acc$12bv32$1;
    v57$2 := $$acc$12bv32$2;
    v58$1 := $$res4$0bv32$1;
    v58$2 := $$res4$0bv32$2;
    ...
    assert {:sourceloc_num 20} {:thread 1} $3$1 != 0bv1;
    assert {:sourceloc_num 20} {:thread 2} $3$2 != 0bv1;
    return;
}
